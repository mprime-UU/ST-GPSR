...
class ContinuousLocalOptimizationMD(FitnessFunction):
    ...
    def _optimize_params(self, individual):
        ...
        individual.set_local_optimization_params(params, self._original_shapes)
...
class ChromosomeInterfaceMD(metaclass=ABCMeta):
    ...
    @abstractmethod
    def set_local_optimization_params(self, flattened_params, shapes):
        # TODO documentation
        raise NotImplementedError
